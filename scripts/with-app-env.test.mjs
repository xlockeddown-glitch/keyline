...
test("this app ships sign-in on — app-env does not set VITE_AUTH_ENABLED false", () => {
...
test("the wrapped command runs with the app env applied", async () => {
  ...
  assert.equal(stdout, String(readAppEnv(projectRoot()).VITE_AUTH_ENABLED ?? "undefined"));
});
