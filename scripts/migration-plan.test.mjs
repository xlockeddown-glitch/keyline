...
test("auth-on workspace globs numbered sql including the copied auth schema", () => {
  ...
  assert.equal(
    pending.filter((m) => m.name === "auth").length,
    0,
    "the auth/ directory must not be treated as a migration",
  );
});
